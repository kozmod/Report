 ...
 * @author xxx
 */
public class PlanTIV implements Clone {
    ...
    public IntegerProperty getRestProperty() {
        return rest;
    }
    ...
    public void setRest(Integer v) {
        this.rest.setValue(v);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!PlanTIV.class.isAssignableFrom(obj.getClass())) {
            return false;
        }
        final PlanTIV other = (PlanTIV) obj;
     ...
     * @return extractor
     */
    public static Callback<PlanTIV, Observable[]> extractor() {
        return (PlanTIV p) -> new Observable[]{
                p.getTypeIDProperty(),
                p.getTypeProperty(),
