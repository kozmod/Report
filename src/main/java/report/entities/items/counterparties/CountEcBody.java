...
public class CountEcBody implements TableClone<CountEcBody>{
    private long id;
     ...
     *                                                                         *
     **************************************************************************/
    public CountEcBody(CountEcBody source ) {
        this.id = id;
     ...
     */
    public static Callback<CountEcBody, Observable[]> extractor() {
        return (CountEcBody p) -> new Observable[]{
                p.exBodyProperty(),
