...
//        return bdValue.doubleValue();
    ...
    public void setSocial(double social) {this.social.set(social); }

    public double getInternal() { return internal.get();}
    public DoubleProperty internalProperty() { return internal;  }
    public void setInternal(double internal) { this.internal.set(internal); }

    public double getExternal() { return external.get();}
    public DoubleProperty externalProperty() { return external; }
    public void setExternal(double external) { this.external.set(external); }

    public double getCyclicalChar() { return cyclicalChar.get(); }
    public DoubleProperty cyclicalCharProperty() {  return cyclicalChar; }
    public void setCyclicalChar(double cyclicalChar) { this.cyclicalChar.set(cyclicalChar); }

    public double getDevStage() { return devStage.get();  }
    public DoubleProperty devStageProperty() {  return devStage;  }
    public void setDevStage(double devStage) {  this.devStage.set(devStage);  }

    public double getCompetition() { return competition.get(); }
    public DoubleProperty competitionProperty() { return competition; }
    public void setCompetition(double competition) {this.competition.set(competition); }

    public double getRegulation() { return regulation.get();  }
    public DoubleProperty regulationProperty() { return regulation;  }
    public void setRegulation(double regulation) { this.regulation.set(regulation); }

    public double getMarketBarriers() {  return marketBarriers.get(); }
    public DoubleProperty marketBarriersProperty() { return marketBarriers; }
    public void setMarketBarriers(double marketBarriers) {  this.marketBarriers.set(marketBarriers);  }
