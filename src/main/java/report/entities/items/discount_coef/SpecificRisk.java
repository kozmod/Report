...
//        return bdValue.doubleValue();
    ...
    public double getKeyChar() {
        return keyChar.get();
    }

    public DoubleProperty keyCharProperty() {
        return keyChar;
    }

    public void setKeyChar(double keyChar) {
        this.keyChar.set(keyChar);
    }

    public double getEntSize() {
        return entSize.get();
    }

    public DoubleProperty entSizeProperty() {
        return entSize;
    }

    public void setEntSize(double entSize) {
        this.entSize.set(entSize);
    }

    public double getFinStruct() {
        return finStruct.get();
    }

    public DoubleProperty finStructProperty() {
        return finStruct;
    }

    public void setFinStruct(double finStruct) {
        this.finStruct.set(finStruct);
    }

    public double getClientDiv() {
        return clientDiv.get();
    }

    public DoubleProperty clientDivProperty() {
        return clientDiv;
    }

    public void setClientDiv(double clientDiv) {
        this.clientDiv.set(clientDiv);
    }

    public double getOtherRisks() {
        return otherRisks.get();
    }

    public DoubleProperty otherRisksProperty() {
        return otherRisks;
    }

    public void setOtherRisks(double otherRisks) {
        this.otherRisks.set(otherRisks);
    }
