...
public class FinResTVI {
    ...
    public String getNContract() {
        return NContract.get();
    }

    public void setNContract(String value_inp) {
        NContract.set(value_inp);
    }
    ...
    public void setDateContract(int value_inp) {
        dateContract.set(value_inp);
    }
    ...
    public void setFinishBuilding(int value_inp) {
        finishBuilding.set(value_inp);
    }
    ...
    public void setSmetCost(double value_inp) {
        smetCost.set(value_inp);
    }

    public Double getCostHouse() {
        return costHouse.get();
    }

    public void setCostHouse(double value_inp) {
        costHouse.set(value_inp);
    }

    public Double getSaleHouse() {
        return saleHouse.get();
    }

    public void setSaleHouse(double value_inp) {
        saleHouse.set(value_inp);
    }
    ...
    public void setTrueCost(double value_inp) {
        trueCost.set(value_inp);
    }
    ...
    public void setProfit(double value_inp) {
        profit.set(value_inp);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!FinResTVI.class.isAssignableFrom(obj.getClass())) {
            return false;
        }
        final FinResTVI other = (FinResTVI) obj;
